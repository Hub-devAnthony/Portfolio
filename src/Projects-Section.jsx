...
function ProjectsSection () {
  ...
  return (
    <div id="project" data-aos="fade-up" data-aos-delay="600">
      ...
      <div className="flex flex-col justify-evenly mt-6 mx-auto h-[600px] w-[85vw] border-gray-300 border rounded-2xl shadow-lg">
      ...
      <div className="mx-auto mt-20 flex flex-col items-center justify-evenly">
        <button className="w-48 h-16 bg-black text-white rounded-lg shadow-sm font-medium text-base">View More</button>
      </div>
    </div>
  );
}
