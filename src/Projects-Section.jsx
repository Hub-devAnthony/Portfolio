  ...
  return (
    <div id="project" data-aos="fade-up" data-aos-delay="600">
      ...
      <div className="flex flex-col justify-evenly mt-10 mx-auto h-[650px] w-[85vw] border-gray-300 border rounded-2xl shadow-lg">
        ...
        <div>
          <button className="ml-6 h-10 w-28 text-white bg-black rounded-lg font-medium text-base">JavaScript</button>
          <button className="ml-2 h-10 w-32 text-white bg-black rounded-lg font-medium text-base">Node.js(basics)</button>
        </div>
      ...
      <div className="flex flex-col justify-evenly mt-10 mx-auto h-[650px] w-[85vw] border-gray-300 border rounded-2xl shadow-lg">
        ...
        <div>
          <button className="ml-6 h-10 w-28 text-white bg-black rounded-lg font-medium text-base">TailwindCSS</button>
          <button className="ml-2 h-10 w-20 text-white bg-black rounded-lg font-medium text-base">React.js</button>
        </div>
      ...
      <div className="flex flex-col justify-evenly mt-10 mx-auto h-[650px] w-[85vw] border-gray-300 border rounded-2xl shadow-lg">
        ...
        <div>
          <button className="ml-6 h-10 w-28 text-white bg-black rounded-lg font-medium text-base">TailwindCSS</button>
          <button className="ml-2 h-10 w-24 text-white bg-black rounded-lg font-medium text-base">JavaScript</button>
        </div>
        <button className="ml-6 h-[50px] w-48 bg-gray-400 rounded-lg font-medium text-base">Live Demo</button>
        <button className="ml-6 h-[50px] w-56 bg-gray-400 rounded-lg font-medium text-base">View Project on Github</button>
      </div>
      ...
      <div className="flex flex-col justify-evenly mt-10 mx-auto h-[650px] w-[85vw] border-gray-300 border rounded-2xl shadow-lg">
        ...
        <div>
          <button className="ml-6 h-10 w-16 text-white bg-black rounded-lg font-medium text-base">CSS</button>
          <button className="ml-2 h-10 w-24 text-white bg-black rounded-lg font-medium text-base">JavaScript</button>
          <button className="ml-2 h-10 w-20 text-white bg-black rounded-lg font-medium text-base">React.js</button>
        </div>
        <button className="ml-6 h-[50px] w-48 bg-gray-400 rounded-lg font-medium text-base">Live Demo</button>
