  ...
  return (
    <>
      ...
      <section data-aos="fade-up" data-aos-delay="600">
        ...
        <p className='ml-2 mt-10 text-base font-medium text-gray-600'>Please check <a href="resume.pdf" download="Anthony's resume.pdf" className='underline'>resume</a> for more details.</p>
      </section>
