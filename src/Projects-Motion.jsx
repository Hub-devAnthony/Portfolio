...
function Motion () {
  ...
  return (
    <section data-aos="fade-up" data-aos-delay="200" className="flex flex-col items-center justify-evenly mt-16 w-full h-[1600px] lg:h-[1300px] border-t border-b border-gray-300">
      ...
      <main className="flex flex-col h-[500px] lg:h-[480px] w-[85vw] border-gray-300 border rounded-2xl shadow-lg">
      ...
      <main className="flex flex-col h-[500px] lg:h-[480px] w-[85vw] border-gray-300 border rounded-2xl shadow-lg">
        <div className="ml-6 mt-20 flex items-center gap-2">
          ...
          <p className="text-center text-lg font-bold text-black">Brand Ambassadorship Opportunities</p>
        </div>
