    ...
    <section data-aos="fade-up" data-aos-delay="200" className="flex flex-col items-center justify-evenly mt-16 w-full h-[1600px] lg:h-[1300px] border-t border-b border-gray-300">
      ...
      <main className="flex flex-col h-[560px] lg:h-[520px] w-[90vw] border-gray-300 border rounded-2xl shadow-lg">
        <div className="ml-4 mt-12 flex items-center gap-2">
          ...
          <p className="mt-6 ml-4 mr-4 text-base font-medium text-gray-600">I love building clean, responsive, and user-focused web interfaces with an eye for detail and functionality.</p>
          <p className="mt-4 ml-4 mr-4 text-base font-medium text-gray-600">As a Software Engineering intern at <a href="https://www.linkedin.com/company/sphere4devs/" className="text-blue-600 underline">DevSphere,</a> I work with technologies like JavaScript, TailwindCSS, and React.js to bring ideas to life through modern design and smooth user experience.</p>
      ...
      <main className="flex flex-col h-[560px] lg:h-[520px] w-[90vw] border-gray-300 border rounded-2xl shadow-lg">
        ...
        <p className="mt-4 ml-4 mr-4 text-base font-medium text-gray-600">I enjoy collaborating with brands that value creativity and community - helping them connect with students in ways that feel authentic and relatable.</p>
        <p className="mt-4 ml-4 mr-4 text-base font-medium text-gray-600">It's all about meaningfull engagement and representing ideas I believe in.</p>
      </main>
    </section>
  );
}
